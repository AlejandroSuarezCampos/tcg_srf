...
<?php /* Qué es esto, en el vocabulario que entiende un buscador. `VideoGame` y
         no `Product`: no se vende nada, y `isAccessibleForFree` lo dice sin
         ambigüedad — la moneda del juego no es dinero real, así que marcar un
         precio aquí sería marcado engañoso.
         `numberOfItems` sale del mismo contador que la portada enseña, así que
         no puede quedarse desfasado cuando entren cartas nuevas. */ ?>
...
<?= json_encode([
  ...
  'genre'               => ['Trading card game', 'Deportes'],
  'gamePlatform'        => 'Navegador web',
  'playMode'            => 'MultiPlayer',
  'applicationCategory' => 'GameApplication',
  'isAccessibleForFree' => true,
  'inLanguage'          => 'es',
  'image'               => seoImagenSocial(),
...
<main id="contenido" class="portada">
    ...
    <div class="wrap pt-hero-cuerpo">
      <div class="pt-hero-texto">
        ...
        <div class="pt-acciones sube">
          <a class="pt-cta" href="registro">
            Abre tu primer sobre gratis
            <i class="ph ph-arrow-right" aria-hidden="true"></i>
          </a>
          <a class="pt-cta-suave" href="plantilla?ver=todas">
      ...
      <?php if ($cartel): ?>
        ...
        <div class="pt-escena inclina-escena" aria-hidden="true">
          ...
          <div class="pt-carta inclina">
            <?php render_carta($cartel, ['modo' => 'arte', 'prioridad' => true]); ?>
          </div>
        </div>
      <?php endif; ?>
    </div>
  ...
  <section class="wrap pt-seccion">
    <div class="pt-cabecera-fila">
      ...
      <a class="pt-mas" href="plantilla?ver=todas">
    ...
    <ul class="pt-vitrina escalona" role="list">
      <?php foreach ($destacadas as $c): ?>
        <li><?php render_carta($c, ['modo' => 'arte', 'href' => 'plantilla']); ?></li>
      <?php endforeach; ?>
    </ul>
  </section>
  <?php endif; ?>
  ...
  <section class="pt-cierre">
    ...
    <div class="wrap pt-cierre-cuerpo">
      ...
      <div class="pt-acciones sube">
        ...
        <a class="pt-cta-suave" href="login">Ya tengo cuenta</a>
      </div>
    </div>
  </section>
