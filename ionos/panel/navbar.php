 ...
 *                   'expansiones' | 'equipos' | 'cadenas' | 'codigos' |
 *                   'misiones' | 'plantillas' | 'usuarios'
 *
...
$enlaces = [
    ...
    ['equipos',     'equipos.php',     'Equipos',         'ph-shield'],
    ...
    /* Al final y separado del resto a propósito: no es contenido del juego,
       son tareas que se pasan de vez en cuando y que borran archivos. */
    ['mantenimiento', 'mantenimiento.php', 'Mantenimiento', 'ph-wrench'],
];
?>
