...
$navJugar = [
	['sobres',   'sobres',   'Sobres',       'ph-package',     'Ábrelos y mira qué cae'],
	['duelos',   'duelos',   'Duelos',       'ph-sword',       'Reta a alguien o entra en una sala'],
	['mazos',    'mazos',    'Alineaciones', 'ph-list-checks', 'Monta el once que vas a sacar'],
	['misiones', 'misiones', 'Objetivos',    'ph-target',      'Lo que te queda por cerrar'],
	['cadenas',  'cadenas',  'Cadenas',      'ph-path',        'Encadena partidos y sube de nodo'],
];

$navTabs = [
	['hoy',       'hoy',       'Hoy',       'ph-house'],
	['jugar',     'jugar',     'Jugar',     'ph-lightning'],
	['plantilla', 'plantilla', 'Plantilla', 'ph-cards'],
	['mercado',   'mercado',   'Mercado',   'ph-storefront'],
	['perfil',    'perfil',    'Perfil',    'ph-user'],
];
...
$MAPA_TABS = [
	...
	'mercado' => 'mercado', 'intercambios' => 'mercado',
...
<header class="barra">
	<div class="barra-interior">
		...
		<a class="marca" href="<?= $base . ($haySesion ? 'hoy' : 'landing') ?>">
			<span class="marca-chispa" aria-hidden="true"></span>
			<img class="marca-imagen" src="<?= $base ?>assets/img/iconos/marca-frontier.png" alt="Frontier TCG">
		</a>
		...
		<div class="barra-derecha">
			<?php if ($haySesion): ?>
				...
				<?php if (!empty($_SESSION['dictador'])): ?>
					<a class="barra-ico" href="<?= $base ?>panel/index" title="Panel de administración">
						<i class="ph ph-sliders" aria-hidden="true"></i>
						<span class="sr-only">Panel de administración</span>
					</a>
				<?php endif; ?>

				<a class="barra-ico" href="<?= $base ?>logout" title="Cerrar sesión">
					<i class="ph ph-sign-out" aria-hidden="true"></i>
					<span class="sr-only">Cerrar sesión</span>
				</a>

				<a class="avatar-enlace" href="<?= $base ?>perfil" title="Tu perfil">
					<span class="avatar">
						<?php if ($navTieneFoto): ?>
			...
			<?php else: ?>
				<a class="btn btn-primary btn-sm" href="<?= $base ?>login">Entrar</a>
			<?php endif; ?>
		</div>
...
<div class="hoja hoja--jugar" id="hoja-jugar" role="dialog" aria-modal="true"
	...
	<div class="hoja-jugar-cab">
		...
		<a class="hoja-jugar-todo" href="<?= $base ?>jugar">
