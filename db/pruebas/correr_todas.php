...
$SUITES = [
    ...
    "probar_dificultad_nodo" => "la dificultad por nodo y las cartas exclusivas de cadena",
    "probar_apuesta_cartas"  => "apostar varias cartas en un duelo y quién se las lleva",
