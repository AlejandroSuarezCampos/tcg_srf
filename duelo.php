...
<div class="modal simulacion" id="simulacionPartido" role="dialog" aria-modal="true"
     ...
     <?php /* EL PARTIDO NO SE CIERRA. Ni con el aspa, ni con Esc, ni pulsando
              fuera. No es un diálogo: es el encuentro. Salirse a medias deja el
              duelo corriendo en el servidor sin nadie delante —los minijuegos
              se resuelven solos con la opción segura, el rival espera y el
              marcador sigue— y quien lo cierra pierde jugadas que sí contaban.
              Dura lo que dura y se cierra solo al terminar. */ ?>
     data-sin-cerrar>
  <div class="modal-caja modal-caja--ancha">
    <div class="modal-head">
      <h2 id="simulacionTitulo">Partido en juego</h2>
      <?php /* AQUÍ HABÍA UN ASPA PARA SALIRSE, y se ha quitado a propósito.
               Ofrecer la salida invitaba a usarla, y usarla no hacía lo que
               parecía: el partido NO se pausa al cerrar. Sigue en el servidor,
               los minijuegos que te tocaran se resuelven solos con la opción
               segura y el marcador se mueve sin ti. Era una puerta que solo
               servía para perder el partido creyendo que lo dejabas guardado.
               El encuentro dura poco más de un minuto y se cierra solo.
               (El reloj del partido ya vive más abajo, en su propio `#simReloj`;
               no se pone otro aquí porque dos elementos con el mismo id dejan a
               `getElementById` devolviendo el primero, y el reloj de verdad se
               quedaría sin actualizar.) */ ?>
    </div>
