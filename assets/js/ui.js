...
(function () {
  ...
  function iniciarFichaCarta() {
    document.addEventListener('click', function (e) {
      ...
      if (carta && rellenarFicha(carta)) {
        /* Si la carta es también un `<a>` (catálogo sin sesión), sin esto el
           modal se abría y, un instante después, el navegador seguía
           igualmente el enlace: se veía el modal solo un parpadeo. */
        e.preventDefault();
