...
require_once __DIR__ . '/seo.php';      // seoCanonical() / seoUrl() / seoImagenSocial()
...
<?php /* ICONOS. El `type` decía image/png sobre un fichero .ico, y /favicon.ico
         en la raíz del dominio daba 404 — que es donde lo buscan los lectores
         de feeds, algunos rastreadores y el propio navegador cuando no
         encuentra la etiqueta. Ahora se declara el tipo correcto y el fichero
         existe también en la raíz. */ ?>
<link rel="icon" type="image/x-icon" href="<?= $base ?>assets/img/iconos/favicon.ico">
<link rel="apple-touch-icon" href="<?= $base ?>assets/img/iconos/apple-icon-180x180.png">

<?php
/* ---------------------------------------------------------------------------
   CANONICAL — la misma página se servía en OCHO URL distintas.
   Cuatro combinaciones de esquema y host (http/https × www/sin-www, las cuatro
   con 200 y contenido idéntico) por dos rutas cada una (`/` y `/landing`,
   `/plantilla` y `/plantilla?ver=todas`…). Sin esta etiqueta, Google elegía una
   por su cuenta y la autoridad de los enlaces se repartía entre ocho en vez de
   sumar en una.
   El .htaccess resuelve el host con un 301; esto resuelve la ruta.
   --------------------------------------------------------------------------- */
$seoCanonical = seoCanonical();
$seoTitulo    = $paginaTitulo . ' · Superliga Frontier TCG';
$seoImagen    = $seoImagen ?? seoImagenSocial();
?>
<link rel="canonical" href="<?= htmlspecialchars($seoCanonical) ?>">

<?php /* OPEN GRAPH Y TWITTER CARD — aquí no había NADA, así que el enlace del
         juego pegado en Discord, en X o en WhatsApp salía vacío: sin imagen,
         sin título y sin descripción. Los valores se calculan de los mismos
         $paginaTitulo/$paginaDesc que ya usan el <title> y la description, así
         que no se pueden contradecir entre sí. Una página puede pisar la imagen
         definiendo $seoImagen antes de incluir este fichero. */ ?>
<meta property="og:site_name" content="Superliga Frontier TCG">
<meta property="og:locale" content="es_ES">
<meta property="og:type" content="website">
<meta property="og:url" content="<?= htmlspecialchars($seoCanonical) ?>">
<meta property="og:title" content="<?= htmlspecialchars($seoTitulo) ?>">
<meta property="og:description" content="<?= htmlspecialchars($paginaDesc) ?>">
<meta property="og:image" content="<?= htmlspecialchars($seoImagen) ?>">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:image:alt" content="Superliga Frontier TCG — el juego de cartas de la Superliga Frontier">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@supligafrontier">
<meta name="twitter:title" content="<?= htmlspecialchars($seoTitulo) ?>">
<meta name="twitter:description" content="<?= htmlspecialchars($paginaDesc) ?>">
<meta name="twitter:image" content="<?= htmlspecialchars($seoImagen) ?>">

<?php /* DATOS ESTRUCTURADOS de sitio, en todas las páginas. Quién publica esto
         y qué es. Las cuentas de `sameAs` son cómo Google ata el dominio a la
         comunidad que ya existe en Discord, Instagram y X: sin ellas son cuatro
         cosas sueltas que nadie relaciona. */ ?>
...
<?= json_encode([
  ...
  '@graph' => [
    [
      ...
      'name'  => 'Superliga Frontier TCG',
      'url'   => seoUrl(),
      'logo'  => seoUrl('assets/img/iconos/apple-icon-180x180.png'),
      'sameAs' => [
        'https://superligafrontier.es/',
        'https://discord.gg/KgEBHA87fF',
        'https://www.instagram.com/superligafrontier/',
        'https://x.com/supligafrontier',
      ],
    ],
    [
      '@type'     => 'WebSite',
