 ...
 *   intercambios    int    ofertas de intercambio esperando su respuesta
...
function hoy_siguiente(array $e): array {
    /* EL ORDEN ES LA DECISIÓN, no el contenido de cada rama:
       ...
       3. lo que CADUCA y además tiene a otra persona esperando
       4. lo que ya se ha ganado y solo falta recoger
       5. lo que está a punto de caer
       6. lo que siempre se puede hacer
    ...
    /* Por delante de cobrar objetivos porque esto SÍ caduca —48 horas— y
       porque al otro lado hay alguien con sus cartas retenidas esperando una
       respuesta. Un objetivo cerrado sigue ahí mañana; una oferta, no. */
    if ((int) ($e['intercambios'] ?? 0) > 0) {
        $n = (int) $e['intercambios'];
        return [
            'tono' => 'amarilla', 'rotulo' => 'Te esperan',
            'titulo' => $n === 1
                ? 'Tienes una oferta de intercambio'
                : 'Tienes ' . $n . ' ofertas de intercambio',
            'texto'  => 'Caducan a las 48 horas de enviarse. Mientras, las cartas siguen retenidas.',
            'accion' => 'Verlas', 'url' => 'intercambios.php', 'icono' => 'ph-swap',
        ];
    }
