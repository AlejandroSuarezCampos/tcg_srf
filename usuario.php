...
cabecera([
  ...
  /* La única puerta de entrada a una oferta dirigida (migración `053`): es
     aquí, mirando lo que tiene, donde da por preguntarle si lo cambia. El
     formulario ya se encarga de enseñar solo lo que puede entregar. */
  'accion'   => '<a class="btn btn-primary" href="intercambios?con=' . $id_perfil . '">'
              . '<i class="ph ph-swap" aria-hidden="true"></i> Proponer intercambio</a>',
  'datos'    => $datosPerfil,
]);
?>
